                                ...
                                {links.map((item) => (
                                    <div key={item} className="relative group">
                                        ...
                                        >
                                            {({ isActive }) => (
                                                <>
                                                    <span className={isActive ? "text-[#103998] dark:text-[#0195be]" : "hover:text-[#0e3389] dark:hover:text-[#0181a4] transition-colors"}>
                                                        {item}
                                                    </span>
                                                    <span className={`absolute rounded-full -bottom-2 -left-2.5 -right-2.5 h-0.5 bg-[#103998] dark:bg-[#0195be] origin-left transition-transform duration-300 ease-out ${isActive ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}></span>
                                                </>
                                            )}
                                        </NavLink>
                                    </div>
                    ...
                    {links.map((item) => (
                        <div key={item} className="relative group w-fit">
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    isActive ? "text-[#103998] dark:text-[#0195be]" : "hover:text-[#0e3389] dark:hover:text-[#0181a4] transition-colors text-black dark:text-white"
                                }
                            >
                                {item}
                            </NavLink>
